...
def _extract_host(df):
    logging.info("Extracting host from urls")
...
def _remove_new_lines_from_body(df):
    logger.info("Cleaning the new lines of body.")
    stripped_body = (df
...
def _save_data(df, filename):
    ...
    logger.info("Saving file at location: {}".format(clean_filename))
